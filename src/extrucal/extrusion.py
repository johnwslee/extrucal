...
class ExtruderScrew:
    ...
    def throughput(self, density, rpm):
        """
    ...
    def throughput_table(self, density, min_rpm=0, max_rpm=100, delta_rpm=10):
        """
    ...
    def throughput_plot(self, density, min_rpm=0, max_rpm=100, delta_rpm=10):
        """
